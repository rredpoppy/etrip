...
public class Destination  implements java.io.Serializable {
    ...
    /**
     * Gets the name value for this Destination.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this Destination.
     * 
     * @param name
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:Etrip.Types", "Destination"));
